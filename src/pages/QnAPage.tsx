...
const QnAPage = () => {
  const qna: QnaType[] = [
    ...
    },
    {
      ...
      answer:
        '<p>- 사용자의 신체 정보와 연구 및 운동 처방에 많이 사용되고 있는 대사 활동량(Metabolic Equivalent of Task, MET)단위를 이용해서 소모한 칼로리를 계산하고 있습니다.<br/>- (전구 이모지 )참고: MET는 1분간 소비되는 단위 체중당 에너지 소비량을 의미합니다.</p>',
    },
  ];
  return (
    <Div>
